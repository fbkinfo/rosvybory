class Ability
  ...
  def initialize(user)
    ...
    if has_role?(user, :tc)
      ...
      can :manage, UserApp, :region_id => user.region.id, :organisation_id => user.organisation_id
      can :manage, User, :region_id => user.region.id, :organisation_id => user.organisation_id

      if user.region.kind.adm_region?
        can :manage, UserApp, :adm_region_id => user.region.id, :organisation_id => user.organisation_id
