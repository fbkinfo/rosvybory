desc 'Создание необходимых таблиц и процедур для работы hstore. Если не проходит, проверьте, что установлен пакет postgresql-contrib'

task :setup_postgres_hstore do
